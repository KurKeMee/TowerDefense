        ...
        try {
            ...
            towerMarket.addAll(Arrays.asList(new Tower(0,
                                                    ...
                                                    new Tower(1,
                                                            ...
                                                            towerAnimationSkeletonKing.get(0),
                                                            towerAnimationSkeletonKing,
                                                            "Skeleton King Tower"),
                                                    new Tower(2,
                                                            150,
                                                            10, //TODO Добавить определение пересечения плоскостей
                                                            1.5 * CELL_WIDTH,
                                                            4,
                                                            new MeleeAttack(
                                                                    AttackRepository.getAttackRepository().getFreeId(),
                                                    ...
                                                    new Tower(3,
                                                            ...
                                                            towerAnimationTripleShooter.get(0),
